# Мини-приложение Морские обитатели
...
(становится активна, только если выбрали хотя бы одну карточку) и окно поиска, фильтрующее по названию и по описанию. 
Внизу есть кнопка показать еще, по которой выводятся следующие карточки, а также кнопка возврата вначало.
